		...
		$('#battle-background').show();
  		...
  		// Render Houses
	   	for(var i = 0; i < houses.length; i++){
	   		var creator = $('<div class="dropdown"><button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">House  <span class="caret"></span></button><ul class="dropdown-menu" aria-labelledby="dropdownMenu1"><li class="list'+houses[0]+'"><a href="#">'+houses[0]+'</a></li><li class="list'+houses[1]+'"><a href="#">'+houses[1]+'</a></li><li class="list'+houses[2]+'"><a href="#">'+houses[2]+'</a></li><li class="list'+houses[3]+'"><a href="#">'+houses[3]+'</a></li><li class="list'+houses[4]+'"><a href="#">'+houses[4]+'</a></li><li class="list'+houses[5]+'"><a href="#">'+houses[5]+'</a></li></ul></div>');
